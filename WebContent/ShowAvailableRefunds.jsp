			...
			<%
				...
				try {
					...
					if (!rs.next()) {
						...
						rs1.next();
						out.println("<tr><td>Reservation ID</td><td>First Name</td><td>Last Name</td><td>Seating Class</td><td>Date of Departure</td><td>Checked In</td><td>Amount</td><td>Refund</td></tr>");
						boolean tf = true;
						...
						while (tf) {
							...
							if(checked_in.equals("0")){
								row = "<tr><td>"+res_id+"</td><td>"+firstname+"</td><td>"+lastname+"</td><td>"+seating_class+"</td><td>" + rs.getTimestamp("date_of_depature") + "</td>"+ "<td>No</td>" +"<td>" + amount +"</td>"+  checkin_button  +  "</tr>";
							}
							else{
								row = "<tr><td>"+res_id+"</td><td>"+firstname+"</td><td>"+lastname+"</td><td>"+seating_class+"</td><td>" + rs.getTimestamp("date_of_depature") + "</td>"+ "<td>Yes</td>" + "<td>" + amount +"</td>"+ "<td>Not Available</td>" +  "</tr>";
							}
							out.println(row);
