...
<%
	...
	//must be signed in
	String flightNumber = request.getParameter("flightNumber1");
	String flightNumber2;
	if (request.getParameter("flightNumber").length() > 1) {
		flightNumber = flightNumber.substring(0, 1);
		flightNumber2 = flightNumber.substring(1, 2);
	}
	if (flightNumber2 != null) {
		sendMail.send("Thanks for buying",
				"You have bought flight number " + flightNumber + " and " + flightNumber2,
